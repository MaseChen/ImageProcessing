...
from tkinter import filedialog, messagebox,Tk,Menu,Canvas,LEFT,NW,Label,SUNKEN,BOTTOM,X,W
...
def exp_gray_transform():
    ...
    processed_image = alg.exp_gray_transform_algorithm(processed_image)
    show_image(processed_image)
...
def fourier_transform():
    global processed_image, history, history_index
    processed_image = alg.fourier_transform_algorithm(processed_image)
    show_image(processed_image)
    history.append(processed_image)
    history_index += 1
...
def global_histogram_equalization():
    global processed_image, history, history_index
    processed_image = alg.global_histogram_equalization_algorithm(
        processed_image)
    show_image(processed_image)
    history.append(processed_image)
    history_index += 1
...
def local_histogram_equalization():
    global processed_image, history, history_index
    processed_image = alg.local_histogram_equalization_algorithm(
        processed_image)
    show_image(processed_image)
    history.append(processed_image)
    history_index += 1
